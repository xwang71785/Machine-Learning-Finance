...
class Vgg16():
    ...
    def ConvBlock(self, layers, filters):
        ...
        for i in range(layers):
            ...
            model.add(Convolution2D(filters, (3, 3), activation='relu', data_format='channels_first'))
    ...
    def finetune(self, batches):
        self.ft(len(batches.class_indices))# batches have no attributes 'nb_class'
    ...
    def fit(self, batches, val_batches, nb_epoch=1):
        # batches.nb_sample is replaced by batches.samples, so is val_batches.nb_sample
